...
function similarityTest(text, pattern) {
  let lvsdist = LCS(text, pattern);
  return ((text.length - lvsdist) / text.length) * 100;
}

// Levenshtein Distance, menghitung jumlah perubahan karakter
// pada pattern agar sesuai dengan text
